...
# Memory: Main_Soc_onchip_mem_for_Tiles
MEM_0 := final_soc_Main_Soc_onchip_mem_for_Tiles
$(MEM_0)_NAME := Main_Soc_onchip_mem_for_Tiles
...
$(MEM_0)_HIERARCHICAL_PATH := Main_Soc_onchip_mem_for_Tiles
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: Main_Soc_onchip_mem_for_Tiles
Main_Soc_onchip_mem_for_Tiles: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: Main_onchip_mem
MEM_1 := final_soc_Main_onchip_mem
$(MEM_1)_NAME := Main_onchip_mem
...
$(MEM_1)_HIERARCHICAL_PATH := Main_onchip_mem
$(MEM_1)_WIDTH := 32
$(MEM_1)_HEX_DATA_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: Main_onchip_mem
Main_onchip_mem: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: Mem_for_Game_Data
MEM_2 := final_soc_Mem_for_Game_Data
$(MEM_2)_NAME := Mem_for_Game_Data
...
$(MEM_2)_END := 0x00013fff
$(MEM_2)_SPAN := 0x00004000
$(MEM_2)_HIERARCHICAL_PATH := Mem_for_Game_Data
$(MEM_2)_WIDTH := 32
$(MEM_2)_HEX_DATA_WIDTH := 32
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: Mem_for_Game_Data
Mem_for_Game_Data: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym

# Memory: keycode_mem
MEM_3 := final_soc_keycode_mem
$(MEM_3)_NAME := keycode_mem
...
$(MEM_3)_START := 0x00015010
$(MEM_3)_END := 0x00015013
$(MEM_3)_SPAN := 0x00000004
$(MEM_3)_HIERARCHICAL_PATH := keycode_mem
$(MEM_3)_WIDTH := 8
...
.PHONY: keycode_mem
keycode_mem: check_elf_exists $(MEM_INIT_DIR)/$(MEM_3).hex $(HDL_SIM_DIR)/$(MEM_3).dat $(HDL_SIM_DIR)/$(MEM_3).sym

# Memory: resource_sdram
MEM_4 := resource_sdram
$(MEM_4)_NAME := resource_sdram
...
$(MEM_4)_START := 0x10000000
$(MEM_4)_END := 0x17ffffff
$(MEM_4)_SPAN := 0x08000000
$(MEM_4)_HIERARCHICAL_PATH := resource_sdram
$(MEM_4)_WIDTH := 32
$(MEM_4)_HEX_DATA_WIDTH := 32
$(MEM_4)_ENDIANNESS := --little-endian-mem
$(MEM_4)_CREATE_LANES := 0

.PHONY: resource_sdram
resource_sdram: check_elf_exists $(HDL_SIM_DIR)/$(MEM_4).dat $(HDL_SIM_DIR)/$(MEM_4).sym
