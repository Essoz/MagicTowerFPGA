...
# setting SOPC_SYSID_BASE_ADDRESS is 0x15018
SOPC_SYSID_FLAG += --sidp=0x15018
ELF_PATCH_FLAG  += --sidp 0x15018

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1641211182
SOPC_SYSID_FLAG += --timestamp=1641211182
ELF_PATCH_FLAG  += --timestamp 1641211182
...
# setting hal.stderr is Main_jtag_uart
ELF_PATCH_FLAG  += --stderr_dev Main_jtag_uart

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is Main_jtag_uart
ELF_PATCH_FLAG  += --stdin_dev Main_jtag_uart
...
# setting hal.stdout is Main_jtag_uart
ELF_PATCH_FLAG  += --stdout_dev Main_jtag_uart
