...
# Memory: USB_onchip_mem
MEM_0 := final_soc_USB_onchip_mem
$(MEM_0)_NAME := USB_onchip_mem
...
$(MEM_0)_HIERARCHICAL_PATH := USB_onchip_mem
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: USB_onchip_mem
USB_onchip_mem: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: keycode_mem
MEM_1 := final_soc_keycode_mem
$(MEM_1)_NAME := keycode_mem
...
$(MEM_1)_START := 0x00009098
$(MEM_1)_END := 0x0000909b
$(MEM_1)_SPAN := 0x00000004
$(MEM_1)_HIERARCHICAL_PATH := keycode_mem
$(MEM_1)_WIDTH := 8
...
.PHONY: keycode_mem
keycode_mem: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
